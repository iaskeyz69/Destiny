...
$db = mysqli_connect("localhost","root","","destinytech_db");
...
function getPro(){ //getPro at index.php
...
<div class='col-md-4 col-sm-6 single' style = 'margin-top: 30px' >
...
<div style = 'margin-top:20px' class='col-md-4 col-sm-6 center-responsive' >
