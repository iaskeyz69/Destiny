...
$edit_cat = "select * from specification_product where spec_id='$edit_id'";
...
$update_cat = "update specification_product set cat_title='$cat_title',cat_top='$cat_top',cat_image='$cat_image' where spec_id='$c_id'";
