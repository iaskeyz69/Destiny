...
$fully_sub_total += $sub_total;

$tax = $fully_sub_total * 0.05;

$total = $fully_sub_total + $tax + 4;
...
<img style = 'display:flex; height: 200px; width: 200px' src='admin_area/product_images/$pro_img1' class='img-responsive' >
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <th> RM<?php echo $fully_sub_total; ?> </th>
