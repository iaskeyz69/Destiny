        ...
        <div class="panel-body">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control" id="dev-table-filter" data-action="filter"
                    data-filters="#dev-manufacturer" placeholder="  Manufacturers">
...
echo "type='checkbox' value='$manufacturer_id' name='manufacturers' class='get_manufacturer'>
<span>
$manufacturer_image
$manufacturer_title
</span>
...
$get_cat = "select * from specification_product where cat_top='yes'";
...
$get_cat = "select * from specification_product where cat_top='no'";
